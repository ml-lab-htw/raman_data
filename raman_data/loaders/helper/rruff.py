...
def give_all_raw(path2read="../rs_dataset/", print_info=True):
    ...
    siamese_minerals = get_minerals_siamese(os.path.join(path2read, "minerals.txt"))
    path_0 = os.path.join(path2read, "unrated_unoriented_unoriented.csv")
    path_1 = os.path.join(path2read, "poor_unoriented_unoriented.csv")
    path_2 = os.path.join(path2read, "fair_unoriented_unoriented.csv")
    path_3 = os.path.join(path2read, "ignore_unoriented_unoriented.csv")
    path_4 = os.path.join(path2read, "excellent_unoriented_unoriented_raw.csv")
